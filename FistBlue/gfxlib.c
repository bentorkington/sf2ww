...
void fight_player_names() {			// 961a
	const static u16 data_96fe[]={PALETTE_0D, 0x1008, 0x1009, 0x0000,  };
...
void actiontickdraw(Object *obj) {		/* 0x41d4 */
    if(--obj->Timer) { return; }
//	printf("actiontickdraw: obj %08x %02x %02x: %08x %02x %08x ", obj, obj->Sel, obj->SubSel,
//		   obj->ActionScript, obj->ActionScript->Loop, obj->ActionScript->Image);
...
void sub_1a0c(void) {			//1a0c unused?
